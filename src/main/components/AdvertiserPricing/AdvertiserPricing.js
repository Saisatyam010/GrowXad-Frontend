...
const AdvertiserPricing = () => {
  const data = {
    ...
    imgUrl:
      "https://imagedelivery.net/f5tF3V4WaB6L98qcq1rX5w/6de390dc-1dc4-42b0-0835-88f663227900/public",
  };
        ...
        <div className="container-fluid mt-3">
          <div className="row">
            <div className="text-center">
              <span className={`${PrcingStyle.dp_advpricing_main_heading} m-0`}>
                Why to Join{" "}
              </span>
              <span
                className={`${PrcingStyle.dp_advpricing_main_heading_color} m-0`}
              >
                GrowXad{" "}
              </span>
            </div>
            ...
            <Row className="d-flex justify-content-center">
              <Col md={7}>
                <div className="text-center pt-3">
                  <span
                    className={`${PrcingStyle.dp_advpricing_main_heading} m-0`}
                  >
                    Broaden your audience and{" "}
                  </span>
                  <span
                    className={`${PrcingStyle.dp_advpricing_main_heading_color} m-0`}
                  >
                    ...
                    <Row key={index}>
                      <Col>
                        <Row className="pt-4">
                          <Col md={6}>
                            <p
                              className={`fw-bold ${PrcingStyle.dp_advpricing_sub_heading}    m-0`}
                            >
                              {pricingSection.title}
                            </p>

                            <p
                              className={`${PrcingStyle.dp_advpricing_main_sub_heading}  fw-bold py-2 m-0`}
                            >
                              {pricingSection.subtitle}
                            </p>

                            <p
                              className={`${PrcingStyle.dp_advpricing_main_sub_heading} m-0`}
                            >
                                    ...
                                    {pricingSection.topVerticals.map(
                                      (vertical, vIndex) => (
                                        <li key={vIndex}>
                                          ...
                                          >
                                            <p
                                              className={`${PrcingStyle.dp_advpricing_main_sub_heading_color} m-0`}
                                            >
                                              {vertical}
                                            </p>
                                          </Link>
