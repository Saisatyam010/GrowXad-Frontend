...
import { signup } from "../../apis/SignupandLogin";
...
function SignupComp() {
  ...
  const {
    ...
    setValue,
    formState: { errors },
  } = useForm({ defaultValues: { isCaptchaVerified: false } });
  ...
  const onSubmit = async (data) => {
    const { isCaptchaVerified, ...rest } = data;
    console.log(data);
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Row>
                ...
                <Col md={6} className="pt-2">
                  <div
                    className={`${
                      errors.messenger ? style.form_input_red : style.form_input
                    } `}
                  >
                    <input
                      className="w-full"
                ...
                <Col md={6}>
                  <div className="form-group pt-2">
                    ...
                    {errors.messengerAccount && (
                      <span className={`pt-1 ${style.field_mandatory}`}>
                        This field is mandatory
                      </span>
                    )}
                  </div>
                ...
                <Col md={6}>
                  <div className="form-group pt-2">
                    ...
                    <input
                      type="hidden"
                      {...register("isCaptchaVerified", {
                        required: "Please Verify the Captcha",
                      })}
                    />
                    <ReCAPTCHA
                      sitekey="6Lda-XUpAAAAAChdLOi6O5a2L5sfROBrY4GNr28d"
                      onChange={(value) => {
                        setValue("isCaptchaVerified", true);
                      }}
                    />
                    {errors.isCaptchaVerified && (
                      <span
                        className="pt-1"
                        style={{ color: "red", fontSize: "12px" }}
                      >
                        {errors.isCaptchaVerified.message}
                      </span>
                    )}
                  </div>
                </Col>
              ...
              <div className="form-group">
                <Button
                  ...
                  style={{
                    ...
                    backgroundColor: "var(--bs-primary-active-bg, #71065d)",
                    boxShadow: "0 0 0 0.2rem rgba(170, 76, 176, 0.5)",
                  }}
                >
                  Signup
                </Button>
