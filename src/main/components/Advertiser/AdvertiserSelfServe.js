    ...
    <>
      <Layout>
        ...
        <section>
          <Container>
            <Row className="justify-content-center ">
              <Col
                md={10}
                className="d-flex justify-content-center pt-4 align-items-center"
              >
                <div className="text-center py-3">
                  <span
                    className={`${AdvertiserSelfServeStyles.dp_SelfService_main_heading}`}
                  >
                    Improve your advertising experience with{" "}
                  </span>
                  <span
                    className={`${AdvertiserSelfServeStyles.dp_SelfService_main_heading_color}`}
                  >
                    General Settings{" "}
                  </span>
                  <span
        ...
        <section>
          ...
          <Container
            className="mt-4 p-5"
            style={{ backgroundColor: "#EEE2FA", borderRadius: "30px" }}
          >
            <Row className=" py-2">
              {selfServePlatform.map((ele) => (
                <Col md={6} className=" pt-3 col-12">
                  <div>
                    <p
                      className={`${AdvertiserSelfServeStyles.dp_SelfService_heading} m-0`}
                    >
                ...
                <Col md={4} className="my-2">
                  ...
                  >
                    <span>
                      ...
                      <p
                        className={`${AdvertiserSelfServeStyles.dp_SelfService_sub_heading} text-center m-0`}
                      >
                        {ele.cardMenuHeading}
                      </p>
                    </span>
            ...
            <Row>
              <Col>
                <div className="d-flex justify-content-center  pt-3">
                  ...
                  >
                    <button
                      className={`MoreButton_serve d-flex align-items-center justify-content-center btn m-0`}
                    >
            ...
            <Row>
              ...
              <Col md={5}>
                <div className={AdvertiserSelfServeStyles.ab_laptopimg}>
                  <img
                    src="https://imagedelivery.net/f5tF3V4WaB6L98qcq1rX5w/c78b85c6-2574-4fe5-d631-c19db9b60400/public"
                    width={500}
                  />
                </div>
              </Col>
            ...
            <Row className="justify-content-center  p-3 mt-2">
              {statisticsData.map((data, index) => (
                <Col key={index} md={4} className={`my-2 `}>
                  <div
                    className={`${AdvertiserSelfServeStyles.dp_selfserve_card}`}
                  >
                    <p
                      className={`${AdvertiserSelfServeStyles.dp_SelfService_sub_heading} m-0 text-center`}
                    >
                      {data.value}
                    </p>
                    <p
