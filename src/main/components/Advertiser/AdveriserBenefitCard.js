        ...
        <Row>
          <Col md={12}>
            <div className="text-center pt-4">
              <span
                className={`${BenefitCardStyles.dp_advbenifits_main_heading}`}
              >
                We do care about{" "}
              </span>
              <span
                className={`${BenefitCardStyles.dp_advbenifits_main_heading_color}`}
              >
                your business{" "}
              </span>
              <span
          ...
          {props.message.map((card, index) => (
            <Col md={3} className="my-2">
              ...
              >
                ...
                <div>
                  <p className={`${BenefitCardStyles.sana_heading} m-0`}>
                    {card.heading}
                  </p>
                </div>

                <div>
                  <p className={`${BenefitCardStyles.sana_contents} m-0 pt-3`}>
                    {card.content}
                  </p>
                </div>
                ...
                <div className={`${BenefitCardStyles.sana_btn_black}`}>
                  ...
                  >
                    <span
                      className={`${BenefitCardStyles.dp_advbenifits_sub_heading}`}
                    ></span>
                    Learn More
                    <FaArrowRight
