            ...
            <Col md={7} className="flex items-center content-center">
              <div className="d-flex justify-content-center align-items-center">
                <div className="">
                  ...
                  <p
                    className={`${welcomeStyles.SSA_HOME_21pxFont} py-1 p-3 text-white`}
                  >
                    {" "}
                    Unlock the full potential of your advertising campaigns with
                    our cutting-edge platform. We are on a mission to empower
                    your brand and extend your influence through revolutionary
                    advertising solutions. Our goal is to provide you with the
                    tools and technology needed to elevate your marketing
                  ...
                  <div class="d-flex justify-content-center p-4 align-items-center">
                    <div className="mr-2 w-40">
                      ...
                      >
                        ...
                        <button
                          type="button"
                          className={`${welcomeStyles.SSA_Btn_HOME_buytraffic} py-3   p-3 w-100`}
                        >
                          BUY TRAFFIC
                        </button>
                      </Link>
