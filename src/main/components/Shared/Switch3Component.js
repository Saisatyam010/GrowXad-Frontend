    ...
    <div>
      <div className="container px-2 py-md-5 py-2  my-md-5 my-3">
        <div className="px-md-5 px-0">
          <div
            className={`row ${AdvertiserBenefitsStyles.dp_advbenifits_3btns}`}
          >
            <div
            ...
            >
              <div className="py-3">
                <div
                  className={`${AdvertiserBenefitsStyles.dp_advbenifits_sub_heading}`}
                >
                  popunder
                </div>
              </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        ...
                        <div>
                          <ul
                            className="ssa_uldot"
                            style={{ fontSize: "var((--section-content))" }}
                          >
