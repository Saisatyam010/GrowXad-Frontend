...
export const AdvertiserBenefitCardMenu = [
    {
        ...
        content:
            "SmartCPM strategically assesses competition to select optimal bids, ensuring ROI maximization within your allocated budget constraints.",
    ...
    },
    {
        ...
        content:
            "SmartCPM automates bid placement, securing wins in auctions 24/7, saving you time previously spent on manual bidding.",
    ...
    },
    {
        ...
        content:
            "Bids adapt in real-time for increased relevant traffic to your promoted offer.",
