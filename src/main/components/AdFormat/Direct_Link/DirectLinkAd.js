            ...
            <div className="row">
              <div className="col-md-6 d-flex align-items-center">
                <div>
                  ...
                  >
                    Direct Link advertising, a time-tested form of online
                    advertising, boasts proven efficiency. These are images or
                    GIF files strategically placed on publishers' websites,
                    mobile sites, and blogs. As per IAB standards, there are
                    typical and highly clickable Direct Link ad formats designed
