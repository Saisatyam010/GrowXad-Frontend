...
import { FaqForHowToStartQuestions } from '../../components/Home/FaqForHowToStartData';
                ...
                <Row>
                    <Col md={12} className='p-4'>
                        <div className='d-flex align-items-center'>
                            ...
                            <span className={`${dropStyles.dp_campaign_guide_sub_items}`}>FAQ for How to Start</span>
                        </div>                   
                    ...
                    <Col md={12}>
                        {FaqForHowToStartQuestions.map((question, index) => (
                             <div
                             key={question.id}
