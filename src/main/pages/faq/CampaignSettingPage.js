...
import { FaqForCampaignSettingsQuestions } from '../../components/Home/FaqForCampaignSettingsData';

export const CampaignSettingPage = () => {
                ...
                <Row>
                    ...
                    <Col md={12} className='p-4'>
                        <div className='d-flex align-items-center'>
                            ...
                            <span className={`${dropStyles.dp_campaign_guide_sub_items}`}>
                                FAQ for Campaign settings
                            </span>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-md-12 text-center">
                                <span className={`text-center py-3 ${dropStyles.dp_faq_main_heading}`}>
                                    FAQ for </span>
                                <span className={`${dropStyles.dp_faq_main_heading_color}`}>Campaign settings</span>
                            </div>
                        </div>
                    ...
                    <Col md={12}>
                        ...
                        {FaqForCampaignSettingsQuestions.map((question, index) => (
                         <div
                         key={question.id}
