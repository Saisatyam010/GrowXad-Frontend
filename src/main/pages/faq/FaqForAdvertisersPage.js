...
import { FaqForAdvertisersQuestions } from '../../components/Home/FaqForAdvertisersData';
          ...
          <Row>
            <Col md={12} className='p-4'>
              <div className='d-flex align-items-center'>
                ...
                <span className={`${dropStyles.dp_campaign_guide_sub_items}`}>FAQ for Advertiser</span>
              </div>
...
export default FaqForAdvertisers