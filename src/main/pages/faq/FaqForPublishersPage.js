...
import { FaqForPublisherQuestions } from '../../components/Home/FaqForPublisherData';

export const FaqForPublishersPage = () => {
        ...
        <Row>
          <Col md={12} className='p-4'>
            <div className='d-flex align-items-center'>
              ...
              <span className={`${dropStyles.dp_campaign_guide_sub_items}`}>FAQ for Publisher</span>
            </div>
            ...
            <div className="row">
              <div className="col-md-12 text-center">
                <span className={`text-center py-3 ${dropStyles.dp_faq_main_heading}`}>
                  FAQ for </span>
                <span className={`${dropStyles.dp_faq_main_heading_color}`}>Publisher</span>
              </div>
            </div>
          </Col>

          <Col md={12}>
            {FaqForPublisherQuestions.map((question, index) => (
               <div
               key={question.id}
